...
layui.define("layer", function(e) {
	...
	u.prototype.set = function(e) {
				...
				select: function() {
					...
					f.each(function(e, l) {
						var r = t(this),
							...
							u = this.disabled,
							d = l.value,
							f = l.selectedIndex > -1 ? (l.options[l.selectedIndex] ? t(l.options[l.selectedIndex]) : t()) : t(),
							v = l.options[0];
		...
		var e = null, 
				 ...
				 s = "layui-form-danger",
				 c = t("#" + z),
				 d = c.find("*[lay-verify]").not("input:hidden");
		 layui.each(d, function(l, r) {
				 ...
				 if (o.removeClass(s), layui.each(c, function(t, l) {
								 ...
								 if (a[l]) {
										 ...
										 }(), { tips: 1 }) : "alert" === u ? i.alert(f, { title: "提示", shadeClose: !0 })
										 : /\bstring|number\b/.test(typeof f) ? i.msg(f, { icon: 5, shift: 6 }) : 0, n.android || n.ios || setTimeout(function() {
											r.focus()
										 }, 7), o.addClass(s), e = !0
								 }
						 }), e) return e
		 ...
		 return !e;
		},u.prototype.VerifyFormAll = function(z) {	 	//展示所有错误提示
			var e = true, 
					 a = f.config.verify,
					 s = "layui-form-danger",
					 c = t("#" + z),
			 ...
			 return e;
			},u.prototype.VerifyFormSingle = function(x) {	//单个input校验
					var e = null, 
						a = f.config.verify,
						s = "layui-form-danger"
						// c = t("#" + z),
						// d = c.find("*[lay-verify]").not("input:hidden");
						// layui.each(d, function(l, r) {
						if(!t(x).attr("lay-verify")) return true
						var o = t(x),
								r= t(x),
								c = o.attr("lay-verify").split("|"),
								u = o.attr("lay-verType"),
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
	...
	H.prototype.config = {
			...
			var i = this,
				...
				a.noParams = a.noParams || false;
			if (i.startTime = (new Date).getTime(), a.url) {
				var r = {};
				if(!a.noParams) r[l.pageName] = e, r[l.limitName] = a.limit;
					...
					.loading(), t.ajax({
						...
						error: function(e, t) {
							...
							// 	.error && a.error(e, t)
								...
								i.errorView("暂无数据"), i.renderForm(), i.setColsWidth(), "function" == typeof a
								.error && a.error(e, t)
						}
					})
